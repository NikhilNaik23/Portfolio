...
export const About = () => {
  ...
  const backendSkills = ["Node.js", "Express.js", "Python", "MongoDB","Socket.io"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)]  transition-all">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>
                <strong>B.tech in Computer Science and Engg.</strong>- Lovely
                Professional University (2022-2026)
              </li>
              <li>
                Relevant Coursework: Data Structure and Algorithms, Web
                Development
              </li>
            </ul>
          </div>
